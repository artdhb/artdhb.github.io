...
function GraficaMXC(evt) {
	...
	get2(urlGrupo,ObtnerDatosAnio,pid);
}
...
function Graficar(ArregloDatos,Etiquetas,Datos) {
	...
	var lienzo = document.createElement("canvas");
		...
		lienzo.setAttribute('height','1000');
		lienzo.setAttribute('width','1300');
...
var urlIns='base/instituto.json';
var urlProf='base/profesor.json';
var urlCarrera='base/carrera.json';
var urlGrupo='base/grupo.json';
var urlAnio='base/anio.json';
